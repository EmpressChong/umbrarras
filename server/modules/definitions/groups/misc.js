...
exports.barricadeTurretShiny = {
    ...
    GUNS: [
        ...
        },
        {
            POSITION: [4, 8, 1.3, 22, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.mini, g.halfrange, {reload: 0.3}]),
                TYPE: "trap",
                STAT_CALCULATOR: gunCalcNames.trap,
            },
        },
...
exports.artilleryTurretShiny = {
    ...
    GUNS: [{
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.gunner, g.arty, {reload: 0.3}]),
            TYPE: "bullet",
            LABEL: "Secondary",
        },
    },
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.arty, {reload: 0.3}]),
                TYPE: "bullet",
                LABEL: "Heavy",
            },
        },
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.swarm, g.morerecoil, g.mach, g.puregunner, {reload: 0.3}]),
                TYPE: ["swarm"],
                STAT_CALCULATOR: gunCalcNames.swarm,
            },
        },
