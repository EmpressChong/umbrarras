...
const {makeOver} = require("../facilitators");
g.lance = {
  reload: 3,
  recoil: 0,
  shudder: 0.1,
...
// BASIC UPGRADES
  ...
  Class.overbasic = makeOver(Class.basic, "Overbase")
...
// AUTO-BASIC UPGRADES
  ...
  Class.overbase = makeOver(Class.basic, "Overbase");
...
// BASEBRID UPGRADES
  ...
  Class.basic.UPGRADES_TIER_1.push("autoBasic", "basebrid");
      ...
      Class.basebrid.UPGRADES_TIER_2 = ["twinbrid", "snipebrid", "poundbrid", "trapbrid", "autoBasebrid", "overbase"];
      Class.overseer.UPGRADES_TIER_3.push("overbase");
};
